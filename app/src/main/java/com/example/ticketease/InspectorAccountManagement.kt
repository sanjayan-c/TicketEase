...
//    var base64String: String? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val inspectorFirstName = intent.getStringExtra("inspectorFirstName")
        val inspectorLastName = intent.getStringExtra("inspectorLastName")
        val inspectorVehicleNo = intent.getStringExtra("inspectorVehicleNo")
        val inspectorVehicleType = intent.getStringExtra("inspectorVehicleType")
        //val InsImage = intent.getStringExtra("InsImage")
        ...
        val inspectorIdTextView = findViewById<TextView>(R.id.inspectorIdview)
        val viewInputFirstName = findViewById<EditText>(R.id.viewInputFirstName)
        val viewInputLastName = findViewById<EditText>(R.id.viewInputLastName)
        val VehicleType = findViewById<TextView>(R.id.VehicleTrip)
        val vehicleNo = findViewById<TextView>(R.id.vehicleNo)


            inspectorIdTextView.text = inspectorID
            viewInputFirstName.text = Editable.Factory.getInstance().newEditable(inspectorFirstName)
            viewInputLastName.text = Editable.Factory.getInstance().newEditable(inspectorLastName)
            VehicleType.text = inspectorVehicleType
            vehicleNo.text = inspectorVehicleNo
                ...
                cusConSQL.conclass { connection ->
                    if (connection != null) {
                        try {
                            ...
                            val query = "UPDATE inspector SET InsFirstname = ?, InsLastname = ?, InsImage = ? WHERE insId = ?"
                            ...
                            preparedStatement.setString(4, inspectorID ) // Set the customer ID
